        ...
        with open("ans.txt","r") as ans:
            while(1):
                ...
                if((l1== "" or l1==None)and(l2=="" or l2==None)):
                    ...
                    if l2=="" or l2 == None:  
                        print("Wrong answer occur in line %d of your ans and in line of test code: "%(i)+"we got "+l1+" when we expected Nothing")
                    else:
                        print("Wrong answer occur in line %d of your ans and in line of test code: "%(i)+"we got "+l1+" when we expected "+l2)
                    break
