...
inline void printgap(int doit,int num)
{
	...
	else if (num==1) strcpy(buffer[buffertop++],hasdeal?"sw\t\t$31,-8192($31)":"sw\t\t$31,4096($31)");
...
inline void printget(int num)
{
	...
	else if (num==1) strcpy(buffer[buffertop++],hasdeal?"addu\t$31,$t2,$31":"addu\t$31,$t0,$31"),nownum++,hasdeal=0;
	else if (num==2) strcpy(buffer[buffertop++],hasdeal?"addu\t$31,$31,$t2":"addu\t$31,$31,$t0"),nownum++,hasdeal=0;
	else if (num==3) strcpy(buffer[buffertop++],hasdeal?"addi\t$31,$31,-12288":"addi\t$31,$31,4"),nownum++,hasdeal=0;
	else if (num==4)
	{
