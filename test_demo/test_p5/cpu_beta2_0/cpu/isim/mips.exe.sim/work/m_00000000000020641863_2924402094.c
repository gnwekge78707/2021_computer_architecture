...
static int ng1[] = {24, 0};
static int ng2[] = {16, 0};
static const char *ng3 = "Instr.txt";
static const char *ng4 = "w";
static int ng5[] = {0, 0};
static int ng6[] = {1024, 0};
static int ng7[] = {1, 0};
static const char *ng8 = "%h @%h: *%h <= %h";
...
LAB2:
LAB4:    *((int *)t3) = xsi_vlogfile_file_open_of_cname_ctype(ng3, ng4);
    t2 = (t3 + 4);
    *((int *)t2) = 0;
    t4 = (t0 + 4936);
...
LAB26:    t2 = (t0 + 4936);
    ...
    t11 = (t0 + 3256U);
    t12 = *((char **)t11);
    xsi_vlogfile_fwrite(*((unsigned int *)t4), 1, 0, 0, ng14, 2, t0, (char)118, t12, 32);
    goto LAB17;
...
LAB29:    t2 = (t0 + 3256U);
    ...
    t2 = (t0 + 2936U);
    t12 = *((char **)t2);
    xsi_vlogfile_write(1, 0, 0, ng8, 5, t0, (char)118, t3, 32, (char)118, t4, 32, (char)118, t11, 32, (char)118, t12, 32);
    goto LAB26;
...
LAB32:    t2 = (t0 + 3256U);
    ...
    *((unsigned int *)t2) = (t27 & 65535U);
    t17 = ((char*)((ng0)));
    xsi_vlogtype_concat(t13, 32, 32, 2U, t17, 16, t15, 16);
    xsi_vlogfile_write(1, 0, 0, ng8, 5, t0, (char)118, t3, 32, (char)118, t4, 32, (char)118, t11, 32, (char)118, t13, 32);
    goto LAB26;
...
LAB35:    t2 = (t0 + 3256U);
    ...
    *((unsigned int *)t2) = (t27 & 255U);
    t17 = ((char*)((ng0)));
    xsi_vlogtype_concat(t13, 32, 32, 2U, t17, 24, t15, 8);
    xsi_vlogfile_write(1, 0, 0, ng8, 5, t0, (char)118, t3, 32, (char)118, t4, 32, (char)118, t11, 32, (char)118, t13, 32);
    goto LAB26;
...
extern void work_m_00000000000020641863_2924402094_init()
{
	...
	xsi_register_didat("work_m_00000000000020641863_2924402094", "isim/mips.exe.sim/work/m_00000000000020641863_2924402094.didat");
