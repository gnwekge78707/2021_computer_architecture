...
LAB67:    t370 = (t0 + 46032);
    ...
    *((unsigned int *)t380) = (t382 | t376);
    xsi_driver_vfirst_trans(t370, 0, 2);
    t383 = (t0 + 40320);
    *((int *)t383) = 1;
...
LAB63:    xsi_vlog_unsigned_bit_combine(t3, 3, t259, 3, t264, 3);
    goto LAB67;
...
LAB76:    xsi_vlog_unsigned_bit_combine(t264, 3, t278, 3, t283, 3);
    goto LAB80;
...
LAB89:    xsi_vlog_unsigned_bit_combine(t283, 3, t297, 3, t302, 3);
    goto LAB93;
...
LAB117:    if (*((unsigned int *)t360) > 0)
        goto LAB118;

LAB119:    if (*((unsigned int *)t322) > 0)
        goto LAB120;

LAB121:    memcpy(t321, t369, 8);

LAB122:    goto LAB101;

LAB102:    xsi_vlog_unsigned_bit_combine(t302, 3, t316, 3, t321, 3);
    goto LAB106;

LAB104:    memcpy(t302, t316, 8);
    goto LAB106;

LAB107:    t337 = *((unsigned int *)t326);
    t338 = *((unsigned int *)t331);
...
LAB114:    t364 = ((char*)((ng9)));
    goto LAB115;

LAB116:    t369 = ((char*)((ng6)));
    goto LAB117;

LAB118:    xsi_vlog_unsigned_bit_combine(t321, 3, t364, 3, t369, 3);
    goto LAB122;

LAB120:    memcpy(t321, t364, 8);
    goto LAB122;
