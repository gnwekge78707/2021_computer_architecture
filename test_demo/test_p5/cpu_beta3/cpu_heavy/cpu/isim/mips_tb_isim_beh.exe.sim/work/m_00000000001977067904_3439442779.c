...
#endif
static const char *ng0 = "C:/Users/86135/Desktop/test_demo/test_p5/cpu_beta3/cpu_heavy/cpu/src/STL.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {3, 0};
static int ng4[] = {2, 0};
...
LAB25:    t305 = (t0 + 13472);
    ...
    *((unsigned int *)t315) = (t317 | t311);
    xsi_driver_vfirst_trans(t305, 0, 2);
    t318 = (t0 + 13200);
    *((int *)t318) = 1;
...
LAB57:    if (*((unsigned int *)t288) != 0)
        goto LAB58;

LAB59:    t295 = (t109 + 4);
    t296 = *((unsigned int *)t109);
    t297 = *((unsigned int *)t295);
    t298 = (t296 || t297);
    if (t298 > 0)
        goto LAB60;

LAB61:    t300 = *((unsigned int *)t109);
    t301 = (~(t300));
...
LAB63:    if (*((unsigned int *)t295) > 0)
        goto LAB64;

LAB65:    if (*((unsigned int *)t109) > 0)
        goto LAB66;

LAB67:    memcpy(t108, t304, 8);
...
LAB64:    xsi_vlog_unsigned_bit_combine(t108, 32, t299, 32, t304, 32);
    goto LAB68;

LAB66:    memcpy(t108, t299, 8);
    goto LAB68;
...
LAB67:    memcpy(t180, t228, 8);

LAB68:    goto LAB47;

LAB48:    xsi_vlog_unsigned_bit_combine(t132, 32, t175, 32, t180, 32);
    goto LAB52;

LAB50:    memcpy(t132, t175, 8);
    goto LAB52;
...
LAB64:    xsi_vlog_unsigned_bit_combine(t180, 32, t223, 32, t228, 32);
    goto LAB68;

LAB66:    memcpy(t180, t223, 8);
    goto LAB68;
...
static void NetDecl_86_4(char *t0)
{
    char t5[8];
    char t8[8];
    char t22[8];
...
extern void work_m_00000000001977067904_3439442779_init()
{
	static char *pe[] = {(void *)Cont_49_0,(void *)Cont_51_1,(void *)Cont_68_2,(void *)Cont_82_3,(void *)NetDecl_86_4,(void *)NetDecl_87_5,(void *)NetDecl_88_6,(void *)NetDecl_89_7,(void *)Cont_90_8,(void *)Cont_92_9,(void *)Cont_93_10,(void *)Cont_94_11,(void *)Cont_95_12,(void *)Cont_96_13,(void *)Cont_97_14};
	xsi_register_didat("work_m_00000000001977067904_3439442779", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000001977067904_3439442779.didat");
