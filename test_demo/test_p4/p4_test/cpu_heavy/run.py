...
os.system("java -jar Mars.jar  a nc mc CompactDataAtZero dump .text HexText code.txt 1000 "+asmfilename)
os.system("java -jar Mars.jar  nc mc CompactDataAtZero dump .text HexText code.txt >out_std.txt 1000 "+asmfilename)
print("std done")
