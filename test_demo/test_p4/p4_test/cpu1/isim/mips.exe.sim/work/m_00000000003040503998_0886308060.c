...
LAB98:    if (*((unsigned int *)t40) > 0)
        goto LAB99;

LAB100:    memcpy(t10, t100, 8);
...
LAB51:    xsi_vlog_unsigned_bit_combine(t10, 32, t42, 32, t43, 32);
    goto LAB55;
...
LAB65:    xsi_vlog_unsigned_bit_combine(t10, 32, t21, 32, t22, 32);
    goto LAB69;

LAB67:    memcpy(t10, t21, 8);
    goto LAB69;
...
LAB97:    xsi_vlog_unsigned_bit_combine(t10, 32, t95, 32, t100, 32);
    goto LAB101;

LAB99:    memcpy(t10, t95, 8);
    goto LAB101;
