...
os.system("java -jar Mars.jar  a nc mc CompactDataAtZero dump .text HexText code.txt 100000 "+asmfilename)
os.system("java -jar Mars.jar  nc mc CompactDataAtZero dump .text HexText code.txt >out_std.txt 100000 "+asmfilename)
print("std done")
