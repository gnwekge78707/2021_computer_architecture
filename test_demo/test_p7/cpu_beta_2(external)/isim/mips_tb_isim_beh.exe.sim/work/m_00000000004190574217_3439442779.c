...
#endif
static const char *ng0 = "C:/Users/86135/Desktop/test_demo/test_p7/cpu_beta_2(external)/src/STL.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {3, 0};
static int ng4[] = {2, 0};
...
LAB63:    if (*((unsigned int *)t346) != 0)
        goto LAB64;

LAB65:    t353 = (t109 + 4);
    t354 = *((unsigned int *)t109);
    t355 = *((unsigned int *)t353);
    t356 = (t354 || t355);
    if (t356 > 0)
        goto LAB66;

LAB67:    t358 = *((unsigned int *)t109);
    t359 = (~(t358));
...
LAB69:    if (*((unsigned int *)t353) > 0)
        goto LAB70;

LAB71:    if (*((unsigned int *)t109) > 0)
        goto LAB72;

LAB73:    memcpy(t108, t362, 8);
...
LAB70:    xsi_vlog_unsigned_bit_combine(t108, 32, t357, 32, t362, 32);
    goto LAB74;

LAB72:    memcpy(t108, t357, 8);
    goto LAB74;
...
LAB36:    t258 = (t0 + 14760);
    ...
    *((unsigned int *)t268) = (t270 | t264);
    xsi_driver_vfirst_trans(t258, 0, 2);
    t271 = (t0 + 14424);
    *((int *)t271) = 1;
...
LAB66:    if (*((unsigned int *)t248) > 0)
        goto LAB67;

LAB68:    if (*((unsigned int *)t210) > 0)
        goto LAB69;

LAB70:    memcpy(t209, t257, 8);

LAB71:    goto LAB50;

LAB51:    xsi_vlog_unsigned_bit_combine(t132, 32, t204, 32, t209, 32);
    goto LAB55;

LAB53:    memcpy(t132, t204, 8);
    goto LAB55;
...
LAB67:    xsi_vlog_unsigned_bit_combine(t209, 32, t252, 32, t257, 32);
    goto LAB71;

LAB69:    memcpy(t209, t252, 8);
    goto LAB71;
...
extern void work_m_00000000004190574217_3439442779_init()
{
	static char *pe[] = {(void *)Cont_53_0,(void *)Cont_57_1,(void *)Cont_76_2,(void *)Cont_90_3,(void *)NetDecl_94_4,(void *)NetDecl_95_5,(void *)NetDecl_96_6,(void *)NetDecl_97_7,(void *)NetDecl_99_8,(void *)Cont_101_9,(void *)Cont_103_10,(void *)Cont_104_11,(void *)Cont_105_12,(void *)Cont_106_13,(void *)Cont_107_14,(void *)Cont_108_15};
	xsi_register_didat("work_m_00000000004190574217_3439442779", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000004190574217_3439442779.didat");
