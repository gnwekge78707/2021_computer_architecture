...
#endif
static const char *ng0 = "C:/Users/86135/Desktop/test_demo/test_p7/test_cmp1.1/mips2/src/D_NPC.v";
...
LAB103:    t248 = (t0 + 1528U);
    ...
    *((unsigned int *)t265) = t274;
    xsi_vlog_mul_concat(t263, 14, 1, t264, 1U, t267, 1);
    xsi_vlogtype_concat(t251, 32, 32, 3U, t263, 14, t253, 16, t252, 2);
    memset(t275, 0, 8);
    xsi_vlog_unsigned_add(t275, 32, t250, 32, t251, 32);
    goto LAB104;

LAB105:    t280 = (t0 + 1688U);
    t281 = *((char **)t280);
    t280 = ((char*)((ng2)));
    memset(t282, 0, 8);
    xsi_vlog_unsigned_add(t282, 32, t281, 32, t280, 32);
    goto LAB106;

LAB107:    xsi_vlog_unsigned_bit_combine(t165, 32, t275, 32, t282, 32);
    goto LAB111;

LAB109:    memcpy(t165, t275, 8);
    goto LAB111;
...
extern void work_m_00000000002463608433_3650585529_init()
{
	...
	xsi_register_didat("work_m_00000000002463608433_3650585529", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000002463608433_3650585529.didat");
