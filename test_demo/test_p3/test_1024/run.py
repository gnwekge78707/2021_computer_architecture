...
for j in range(1):
	...
	os.system("java -jar logisim.jar std.circ -tty table >out_std.txt 10000")
	print("std done")
		...
		with open("out_std.txt","r") as std:
			while(1):
				...
				if (asm[0]!="j" or asm[0]=="jal") and asm[0]!="b":
					...
					if(l1_rtl!=l2_rtl):
						errcnt+=1
						print("WA at line:%d "%(i)+"source::"+l1_rtl+"	std::"+l2_rtl+"	asm::"+asm)
					else:
						print("AC at line:%d "%(i)+"		asm::"+asm)
	print("TOTAL ERR SPOTTED::::!!!%d!!!"%errcnt)
